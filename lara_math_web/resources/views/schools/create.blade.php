...
@section('content')
    <h1 class="text-2xl font-bold mb-6">Add New School</h1>
    ...
    <form action="{{ route('schools.store') }}" method="POST" class="space-y-4">
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" id="address" class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="email" name="representative_email" id="representative_email" class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
        </div>
        <div class="form-group">
            <label for="representative_name" class="block text-sm font-medium text-gray-700">Rep Name</label>
            <input type="text" name="representative_name" id="representative_name" class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
        </div>
        <button type="submit" class="btn btn-primary bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md">Add School</button>
    </form>
@endsection
